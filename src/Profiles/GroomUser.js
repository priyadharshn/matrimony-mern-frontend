...
function GroomUsers() {
   ...
   const getmaleusers = async () => {
      let result = await fetch(`http://localhost:5000/getmaleusers/${params.id}`);
   ...
   const onDeleteData = async () => {
      if (window.confirm("Are you sure remove your account? ")) {
         let response = await axios.delete(`http://localhost:5000/delmaleusers/${params.id}`);
                           ...
                           <div className="col-md-8">
                              <div className="tab-content profile-tab" id="myTabContent">
                                 <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    ...
                                    <Link to={"/updateMale/" + item._id}><button className="btn btn-dark" id="btn" type="button">Edit</button></Link>
