...
// const updateUsers = async() => {
    //     console.log(First_Name, Last_Name, Email, Phone_Number, Age, Gender, Height, Weight, Religion, Profession, Upload_Photo)
    //     let result = fetch(`http://localhost:5000/update/${params.id}`, {
    //         method: 'POST',
    //         withCredentials: true,
    //         body: JSON.stringify({ First_Name, Last_Name, Email, Phone_Number, Age, Gender, Height, Weight, Religion, Profession, Upload_Photo }),
    //         headers: {
    ...
    // }
     {/* <div className="form-group">
                    ...
                    <div className="col-sm-9">
                        <input type="date" id="birthDate" name="Birth_Date" className="form-control" value={Birth_Date}
